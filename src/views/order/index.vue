      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <table class="goods">
            ...
            <tbody>
              <tr v-for="item in orderStore.orderInfo.goods" :key="item.id">
                <td>
        ...
        <div class="box-body">
          <div class="total">
            <dl>
              <dt>商品件数：</dt>
              <dd>{{ orderStore.orderInfo.summary?.goodsCount }}件</dd>
            </dl>
            <dl>
              <dt>商品总价：</dt>
              <dd>
                ¥{{ orderStore.orderInfo.summary?.totalPrice.toFixed(2) }}
              </dd>
            </dl>
            <dl>
              <dt>运<i></i>费：</dt>
              <dd>¥{{ orderStore.orderInfo.summary?.postFee.toFixed(2) }}</dd>
            </dl>
            <dl>
              <dt>应付总额：</dt>
              <dd class="price">
                {{ orderStore.orderInfo.summary?.totalPayPrice.toFixed(2) }}
              </dd>
            </dl>
          </div>
        </div>
